...
mod graph_conflict_tests {
    ...
    fn test_double_spend_detection() {
        ...
        engine
            .register_transaction(&tx, tx2_hash.clone(), 2000, 1000)
            .ok();
    ...
    fn test_get_conflicts() {
        ...
        engine
            .register_transaction(&tx, tx1_hash.clone(), 1000, 0)
            .ok();
        engine
            .register_transaction(&tx, tx2_hash.clone(), 2000, 1000)
            .ok();
    ...
    fn test_dependency_management() {
        ...
        engine
            .register_transaction(&tx, parent.clone(), 1000, 0)
            .ok();
        engine
            .register_transaction(&tx, child.clone(), 2000, 1000)
            .ok();
